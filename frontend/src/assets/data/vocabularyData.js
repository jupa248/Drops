...
export const vocabularyData = [
    {
      ...
      categories: [
        ...
        },
        {
          title: 'floral',
          descriptors: [
            'acacia', 'honeysuckle', 'chamomile', 'elderflower',
            'geranium', 'blossom', 'rose', 'violet'
          ]
        },
        {
          title: 'Green fruit',
    ...
    },
    {
      ...
      categories: [
        ...
        {
          title: 'Oak',
          descriptors: ['vanilla', 'cloves', 'nutmeg', 'coconut', 'butterscotch', 'toast', 'cedar']
        }
      ]
    },
    {
      ...
      categories: [
        {
          title: 'Key questions',
          questions: ['Do the flavours show deliberate oxidation?', 'Do the flavours show fruit development?', 'Do the flavours show bottle age?']
        },
        {
        ...
        },
        {
          ...
          descriptors: ['dried apricot', 'marmalade', 'dried apple', 'dried banana', 'etc.']
        },
        {
          title: 'Fruit development (Red)',
          descriptors: ['fig', 'prune', 'tar', 'dried blackberry', 'dried cranberry', 'cooked blackberry', 'cooked red plum', 'etc.']
        },
        {
